...
<h1 class="h3 mb-2 text-gray-800"><?php echo $data['titulo']; ?></h1>
 <p class="mb-4">Una tabla para las categorias</p>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover responsive nowrap" id="tabla_departamentos" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Nombre <i class="fa-solid fa-signature" style="color: #005cfa;"></i></th>
                        ...
                        <?php foreach($data['categorias'] as $data){ ?>
                            <tr class="table">
                                <td> <?php echo $data['nombre_categoria'] ?> </td>
                                <td> <?php echo $data['descripcion'] ?> </td>
                                <td> <?php echo $data['fecha_creada'] ?> </td>
                                <td> <?php echo $data['nombres'] ?> </td>
                                <td>                         
                                    <a class="btn btn-primary" href='edit/<?php echo $data['id_categoria'] ?>'>                                        
                                        Editar
                                    </a>                    
                                </td>
                            </tr>
