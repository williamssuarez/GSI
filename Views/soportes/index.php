            ...
            <table class="table table-striped table-bordered table-hover responsive" id="tablaequipos_ingresados" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>Nombres <i class="fa-solid fa-user-gear" style="color: #005af5;"></i></th>
                        <th>Apellidos <i class="fa-solid fa-user-gear" style="color: #005af5;"></i></th>
                        <th>Caso <i class="fa-solid fa-triangle-exclamation" style="color: #f50a0a;"></i></th>
                        <th>Tipo <i class="fa-solid fa-question" style="color: #5b0d9b;"></i></th>
                        <th>Fecha Soporte</th>
                        <th>Estado</th>
                ...
                <tbody>
                    ...
                    <?php foreach($soportes['abiertos'] as $data) { ?>
                        <tr>
