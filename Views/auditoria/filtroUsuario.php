...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800"><?php echo $_SESSION['filtrousuario']['titulo']; ?></h1>
 <p class="mb-4">Una tabla para consultar la auditoria</p>

<h1 class="h3 mb-2 text-gray-800">Tabla</h1>

<br></br>
<a class="btn btn-danger" href="<?php echo URL; ?>/auditoria/salirFiltroUsuario">
    Deshacer
</a>
<br></br>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover responsive nowrap" id="tabla_auditoria" width="100%" cellspacing="0">
                        ...
                        <?php foreach($_SESSION['filtrousuario']['auditoria'] as $data){ ?>
                            <tr class="table">
