<?php $rechazos = $equipos->rechazosOperador(); ?>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-hover responsive nowrap" id="tablaequipos_rechazadosOpr" width="100%" cellspacing="0">
                <thead>
                    <tr>
