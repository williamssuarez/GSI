...
<h1 class="h3 mb-2 text-gray-800"><?php echo $data['titulo']; ?></h1>
 <p class="mb-4">Introduzca la razon de reactivacion de la cuenta del usuario <?php echo $data['nombre_usuario'] ?></p>
                ...
                <div class="col-lg-5 d-none d-lg-block bg-register">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Razon de reactivacion</h1>
                        </div>
